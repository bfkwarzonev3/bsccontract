...
contract BFK is ERC20, Ownable {
    ...
    constructor() ERC20("BFK WARZONE", "BFK") {
        ...
        buyDevFee = 3;
        buyEcosystemFee = 2;
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyDevFee + buyEcosystemFee;

        sellOperationsFee = 3;
        sellLiquidityFee = 1;
        sellDevFee = 3;
        sellEcosystemFee = 2;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellDevFee + sellEcosystemFee;

        operationsAddress = address(0xFe0E0143286F9e2e7F9F061C0BB0c00eF178A622);
        devAddress = address(0xFe0E0143286F9e2e7F9F061C0BB0c00eF178A622);
        ecosystemAddress = address(0xFe0E0143286F9e2e7F9F061C0BB0c00eF178A622);
        liquidityAddress = address(0xFe0E0143286F9e2e7F9F061C0BB0c00eF178A622);
        futureOwnerAddress = address(0x5810a0D422E725B93BD362a4A18d990089048975);
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _devFee, uint256 _ecosystemFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _devFee, uint256 _ecosystemFee) external onlyOwner {
    ...
    function swapBack() private {
        ...
        if(tokensForEcosystem > 0 && balanceOf(address(this)) >= tokensForEcosystem) {
            _transfer(address(this), address(ecosystemAddress), tokensForEcosystem);
        }
